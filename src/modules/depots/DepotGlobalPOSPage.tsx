                ...
                <div key={key} className="bg-white border border-surface-200 rounded-2xl p-4 shadow-sm relative">
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span className="inline-block mt-0.5 px-1.5 py-0.5 rounded-md bg-primary-50 text-primary-600 text-[10px] font-medium">{item.locationName}</span>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <span className="ml-auto text-lg font-bold text-primary-600">{currency(item.quantity * item.unitPrice)}</span>
                  </div>
                </div>
              )
            })}
